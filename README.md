...
```bash
curl -fsSL https://raw.githubusercontent.com/gkyang2022/farsight-nas-media-stack/main/fnserver.sh -o fnserver.sh && sudo chmod +x fnserver.sh && sudo ./fnserver.sh
